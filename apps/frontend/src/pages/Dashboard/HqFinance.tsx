    ...
    <div>
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12} lg={6}>
          <Card><Statistic title="全网收入总额" value={totalRevenue} precision={2} prefix={<DollarOutlined />} suffix="元" /></Card>
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <Card><Statistic title="总部抽佣总额" value={totalCommission} precision={2} prefix={<FundOutlined />} suffix="元" valueStyle={{ color: '#3f8600' }} /></Card>
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <Card><Statistic title="全网预算总额" value={totalBudget} precision={2} prefix={<CheckCircleOutlined />} suffix="元" /></Card>
        </Col>
        <Col xs={24} sm={12} lg={6}>
          <Card><Statistic title="已使用预算" value={totalUsed} precision={2} prefix={<AlertOutlined />} suffix="元"
            valueStyle={{ color: totalBudget > 0 && totalUsed / totalBudget > 0.8 ? '#cf1322' : '#3f8600' }} /></Card>
        </Col>
      </Row>
