    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 420, textAlign: 'center' }}>
          <div style={{ fontSize: isMobile ? 40 : 56, marginBottom: 8, filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))' }}>
            <span role="img" aria-label="pet">&#x1F3C6;</span>
          </div>
          <Title level={isMobile ? 3 : 2} style={{ color: '#fff', marginBottom: 4, letterSpacing: 2 }}>IPOC</Title>
          <Title level={5} style={{ color: 'rgba(255,255,255,0.85)', fontWeight: 400, marginBottom: isMobile ? 0 : 40, lineHeight: 1.6 }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: 24, textAlign: 'center' }}>
          <Text type="secondary" style={{ fontSize: 12 }}>
            V1.0 &middot; Powered by IPOC Tech
            {isMobile && <><br />&copy; {new Date().getFullYear()} IPOC 组委会</>}
          </Text>
        </div>
      </div>
    </div>
